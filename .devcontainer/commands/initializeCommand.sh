...
DIAGNOSIS_DIR_NAME=docs/diagnosis
DIAGNOSIS_DIR_PATH=${containerWorkspaceFolder}/docs/diagnosis
...
WORKSPACE_HUB_CONTAINER_DIR_PATH=/workspace-hub
...
DIAGNOSIS_PLUTO_FILE_PATH=${DIAGNOSIS_DIR_PATH}/pluto.diagnosis.md
DIAGNOSIS_PLUTO_TARGET_K8S_VERSION=1.36.0
...
# Workspace Hub Arguments
WORKSPACE_HUB_CONTAINER_DIR_PATH=$WORKSPACE_HUB_CONTAINER_DIR_PATH
...
# OCI Arguments
OCI_CONFIG_FILE=${containerWorkspaceFolder}/${OCI_CONFIG_DIR_NAME}/oci.config
...
# Cursor Arguments
CURSOR_GENERATE_BRANCH_NAME_AI_MODEL=composer-2.5-fast
CURSOR_GENERATE_COMMIT_MESSAGE_AI_MODEL=composer-2.5
CURSOR_GENERATE_PULL_REQUEST_AI_MODEL=gpt-5.6-sol-medium
CURSOR_SYNTH_PROJECT_README_AI_MODEL=claude-sonnet-5
