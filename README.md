...
Generated at ```2026-08-04T12:40:30.713Z```
...
| ------- | ----- | --------- | ----------------- | -------------- | -------- | ---------- |
| argo-cd | argo-cd | argo-cd | 10.2.1 (app: v3.4.5) | 10.2.2 (app: v3.4.6) | Yes | No |
| argo-rollouts | argo-rollouts | argo-rollouts | 2.41.0 (app: v1.9.0) | 2.41.1 (app: v1.9.1) | Yes | No |
| cert-manager | cert-manager | cert-manager | v1.21.0 (app: v1.21.0) | v1.21.1 (app: v1.21.1) | Yes | No |
| coder | coder | coder | 2.35.3 (app: 2.35.3) | 2.36.0 (app: 2.36.0) | Yes | No |
...
| ghcr.io/kube-vip/kube-vip | v1.0.3 | v1.2.2 | v1.2.2 | v1.0.4 |
...
| ghcr.io/coder/coder | v2.35.3 | v2.36.0 | v2.36.0 | v2.35.3 |
...
| ecr-public.aws.com/docker/library/redis | 8.2.3-alpine | 8.10.0 | 8.10.0 | 8.2.8 |
| quay.io/jetstack/cert-manager-cainjector | v1.21.0 | v1.21.1 | v1.21.1 | v1.21.1 |
| quay.io/jetstack/cert-manager-controller | v1.21.0 | v1.21.1 | v1.21.1 | v1.21.1 |
| quay.io/jetstack/cert-manager-webhook | v1.21.0 | v1.21.1 | v1.21.1 | v1.21.1 |
| registry.istio.io/release/ztunnel | 1.30.3-distroless | 1.30.3 | 1.30.3 | 1.30.3 |
| quay.io/argoproj/argo-rollouts | v1.9.0 | v1.9.1 | v1.9.1 | v1.9.1 |
