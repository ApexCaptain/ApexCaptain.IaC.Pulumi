...
Generated at ```2026-09-07T08:34:19.366Z```
...
| ------- | ----- | --------- | ----------------- | -------------- | -------- | ---------- |
| argo-cd | argo-cd | argo-cd | 10.8.0 (app: v3.5.2) | 10.8.2 (app: v3.5.2) | Yes | No |
| cilium | cilium | kube-system | 1.19.3 (app: 1.19.3) | 1.21.0-pre.0 (app: 1.21.0-pre.0) | Yes | No |
| grafana | grafana | monitoring | 13.2.1 (app: 13.2.1) | 13.2.2 (app: 13.2.1) | Yes | No |
| victoria-metrics | victoria-metrics-single | monitoring | 0.45.0 (app: v1.150.0) | 0.46.0 (app: v1.151.0) | Yes | No |
...
| victoriametrics/victoria-metrics | v1.150.0 | v1.151.0 | v1.151.0 | v1.150.0 |
...
Generated at ```2026-09-07T08:34:19.390Z```
...
No deprecated or removed API versions found for Kubernetes target ```v1.36.0```.
