...
export class RepositoryCertificate extends pulumi.CustomResource {
     ...
     */
    declare public readonly https: pulumi.Output<outputs.RepositoryCertificateHttp[] | undefined>;
    /**
     * SSH certificate configuration
     */
    declare public readonly sshes: pulumi.Output<outputs.RepositoryCertificateSsh[] | undefined>;
    ...
    constructor(name: string, argsOrState?: RepositoryCertificateArgs | RepositoryCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RepositoryCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
