...
interface VirtualServiceV1CrdArgsShape {
  metadata: {
    name: string;
    namespace: string;
  };
...
export type VirtualServiceV1CrdArgs =
  utils.types.DeepPulumiInput<VirtualServiceV1CrdArgsShape>;

export class VirtualServiceV1Crd
  extends kubernetes.apiextensions.CustomResource {
  constructor(
    name: string,
    args: VirtualServiceV1CrdArgs,
