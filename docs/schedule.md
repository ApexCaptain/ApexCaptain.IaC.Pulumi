...
| 부작용 분리 이슈 수용 기준 충족·머지 후 | `projenrc/workflows`·`projenrc/projects`로 팩토리 이동. `pnpm exec projen` 후 생성물 의도 diff 없음 | [projenrc 모듈화](issues/2026-09-11-projenrc-modularize.md) | 보류 |
